    ...
    return (
        <div className="">
            {items?.length && items.map((item, index) => {
                return (<div className="flex-col justify-end lg:flex-row flex lg:justify-between items-end lg:items-center px-10 py-5">
                    <div className="flex flex-col lg:flex-row gap-5 items-center">
                        <div className="w-40 h-40">
                            <img src={item1} alt="" />
                        </div>
                        <div>
                            <p className="text-xl text-black mb-3">{item.name}</p>
                    ...
                    <div>
                        <div className="flex items-center text-lg font-bold text-black">
                            <BiRupee /><p className="mb-0 font-bold">{item.price} x {item.quantity}</p>
                        </div>
                        <div>
                            <p className="mb-0 font-bold text-black text-end">= {item.price * item.quantity}</p>
                        </div>
                    </div>
                </div>)
            })}
